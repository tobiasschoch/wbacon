...
Table 1: Benchmarks: Robust linear regression (single-threaded)
...
| $n = 10^5$ | 0.1 | 0.3 | 0.8 | 1.3 | 2.0 | 2.3 | 4.7 |  9.9 |
| $n = 10^6$ | 0.9 | 1.5 | 2.2 | 2.8 | 4.0 | 4.1 | 7.7 | 13.7 |

Table 2: Benchmarks: Multivariate outlier nomination/ detection (multi-threaded)
