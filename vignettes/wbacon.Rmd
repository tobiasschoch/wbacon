...
Make sure that the package `devtools` is installed.<sup>[1](#notes)</sup> Then, the `wbacon` package can be pulled and installed from [www.github.com/tobiasschoch/wbacon](https://www.github.com/tobiasschoch/wbacon) using
